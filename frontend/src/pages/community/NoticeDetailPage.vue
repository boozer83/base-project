  ...
  <div class="notice-detail-page" v-loading="loading">
    <template v-if="notice">
      <div class="detail-header">
        <el-tag v-if="notice.isPinned" type="danger" class="pin-tag">공지</el-tag>
      ...
      <div class="detail-actions">
        <el-button @click="router.push('/community/notice')">목록</el-button>
        <template v-if="authStore.isAdmin">
          <el-button
            type="primary"
            @click="router.push(`/community/notice/${notice.id}/edit`)"
          >
            수정
          </el-button>
